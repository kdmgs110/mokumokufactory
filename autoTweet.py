...
tweets = [
      ...
      #''' 13'''  
              "第一志望にうからなかった場合、現役で妥協するか、浪人で苦労してレベルの高い大学に入るべきか悩むと思いますが、浪人についての研究がありました。" #5
              + "{}".format("http://www.the-academic-times.com/2017/05/its-better-to-prepare-for-exam-for-years.html"),

      #''' 14'''  
              "マシュマロ実験は、1960年代に行われた実験です。将来より大きな成果のために、自分の感情をコントロールして、目先の欲求を我慢する満足遅延耐性(delayed gratification)についての実験です。" #6
              + "{}".format("http://www.the-academic-times.com/2017/05/successful-children-has-self-control-skill.html")        
        ]
